...
<html>
	<head>
		...
		<title>Total Revenue per Customer</title>
	</head>
	<body>
		<jsp:include page="navBarAdmin.jsp"/>	
		<h1>Total Revenue per Customer</h1>
		...
		<%
			try {
				...
				String query = "SELECT username as customer, SUM(totalFare) AS revenue FROM books GROUP BY customer";
